...
public class MainActivity extends Activity implements android.view.View.OnClickListener {
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
		/*
		 * case R.id.buttonSort: { this.setContentView(R.layout.sort);
		 * 
		 * input1 = (EditText) findViewById(R.id.input1); input2 = (EditText)
		 * findViewById(R.id.input2); input3 = (EditText)
		 * findViewById(R.id.input3); input4 = (EditText)
		 * findViewById(R.id.input4); input5 = (EditText)
		 ...
		 * input2.getText().toString(); uname3 = input3.getText().toString();
		 * uname4 = input4.getText().toString(); uname5 =
		 ...
		 * (a[j].compareTo(a[j + 1]) >= 1) { temp = a[j]; a[j] = a[j + 1]; a[j +
		 * 1] = temp; }
		 * 
		 * } }
		 * 
		 * this.setContentView(R.layout.main); result = (TextView)
		 * findViewById(R.id.resulter); for (i = 0; i < 5; i++)
		 * result.append("\n" + a[i]); } break; case R.id.buttonReseter: {
		 ...
		 * Integer.parseInt(a.getText().toString()); if
		 * ((b.getText().toString()) == " ") y = 1; else y =
		 * Integer.parseInt(b.getText().toString()); if
		 ...
		 * 
		 * int x = 1, y = 1, z = 1; if ((a.getText().toString()) == " ") x = 1;
		 * else x = Integer.parseInt(a.getText().toString()); if
		 * ((b.getText().toString()) == " ") y = 1; else y =
		 * Integer.parseInt(b.getText().toString()); if
		 * ((c.getText().toString()) == " ") z = 1; else z =
		 * Integer.parseInt(c.getText().toString());
		 ...
		 * reesult = "(x" + re1 + "),(x" + re2 + ")";
		 * this.setContentView(R.layout.main); result = (TextView)
		 * findViewById(R.id.resulter); result.setText(reesult); reesult = "";
		 * 
		 ...
		 * {
		 * 
		 * no = unameMul.getText().toString(); n = (int) (no.charAt(0)); if (n
		 * >= 48 && n <= 57) {
		 * 
		 * num = Integer.parseInt(no); /* int l=no.length(); for(int
		 * j=0;j<l;j++){
		 * 
